...
Floor::Floor()
{
	...
	color = { 0,1,0,1 };
	Object::Update();
	std::unique_ptr<BoxCollider> collider(new BoxCollider({ -22,-1,-22,0 },{23,1,23} ));
	...
	std::unique_ptr<BoxCollider> collider2(new BoxCollider({ 22,-1,-22,0 }, { 23,1,23 }));
	...
	std::unique_ptr<BoxCollider> collider3(new BoxCollider({ -22,-1,22,0 }, { 23,1,23 }));
	...
	std::unique_ptr<BoxCollider> collider4(new BoxCollider({ 22,-1,22,0 }, { 23,1,23}));
